    ...
    <div class="col-xs-12">
        <div class="portlet box default">
            <div class="portlet-title">
                <div class="caption">
                    <i class="livicon" data-name="pen" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> {{ __('acl.edit_table_title') }}
                </div>
            </div>
            <div class="portlet-body">
                {!! Form::open(array('route' => array('acl.update', $acl), 'method' => 'put', 'role' => 'form', 'class' => 'form-horizontal')) !!}

                <fieldset>
                    <div class="form-group">
                        {!! Form::label('permission_id', __('permission.permission_name'), ['class' => 'col-md-3 control-label']) !!}
                        <div class="col-md-9">
                            {!! Form::select('permission_id', $permissions, old('permission_id', $acl->permission_id), array('class' => 'form-control')) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('controller', __('acl.controller_class'), ['class' => 'col-md-3 control-label']) !!}
                        <div class="col-md-9">
                            {!! Form::text('controller', old('controller', $acl->controller), array('class' => 'form-control')) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('action', __('acl.action_name'), ['class' => 'col-md-3 control-label']) !!}
                        <div class="col-md-9">
                            {!! Form::text('action', old('action', $acl->action), array('class' => 'form-control')) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="checkbox" id="show_in_menu" name="show_in_menu" class="custom-checkbox" value="1" @if(old('show_in_menu', $acl->show_in_menu) == 1) checked='checked' @endif />
                        </div>
                    </div>
                    <div class="form-group">
