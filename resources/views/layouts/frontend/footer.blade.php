        ...
        <div class="col-sm-4">
            ...
            <div class="media">
                <div class="media-left media-top">
                    <a href="#">
                        <img class="media-object" src="{!! asset('themes/josh/frontend/images/image_14.jpg') !!}" alt="image">
                    </a>
                </div>
            ...
            <div class="media">
                <div class="media-left media-top">
                    <a href="#">
                        <img class="media-object" src="{!! asset('themes/josh/frontend/images/image_15.jpg') !!}" alt="image">
                    </a>
                </div>
                <div class="media-body">
                    <p class="media-heading">Lorem Ipsum is simply dummy text of the printing and type setting industry dummy.
            ...
            <div class="media">
                <div class="media-left media-top">
                    <a href="#">
                        <img class="media-object" src="{!! asset('themes/josh/frontend/images/image_13.jpg') !!}" alt="image">
                    </a>
                </div>
                <div class="media-body">
                    <p class="media-heading">Lorem Ipsum is simply dummy text of the printing and type setting industry dummy.
            ...
            <div class="media">
                <div class="media-left media-top">
                    <a href="#">
                        <img class="media-object" src="{!! asset('themes/josh/frontend/images/c1.jpg') !!}" alt="image">
                    </a>
                </div>
                <div class="media-body">
                    <p class="media-heading">Lorem Ipsum is simply dummy text of the printing and type setting industry dummy.
