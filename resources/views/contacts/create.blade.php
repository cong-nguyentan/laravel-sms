    ...
    <div class="col-xs-12">
        <div class="portlet box default">
            <div class="portlet-title">
                <div class="caption">
                    <i class="livicon" data-name="pen" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> {{ __('contact.add_table_title') }}
                </div>
            </div>
            <div class="portlet-body">
                {!! Form::open(array('route' => array('contacts.store'), 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal')) !!}
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            @endphp
                            {!! Form::select('groups[]', $listFilterGroupContacts, old('groups', ""), array('class' => 'form-control', 'multiple' => true, 'id' => 'groups')) !!}
                        </div>
                    </div>
                    <div class="form-group">
